...
- only handles multiplexing ![[Pasted image 20241112144653.png|300]]
...
- "connectionless" packet delivery![[Pasted image 20241112144614.png|300]]
...
- TCP delivery ![[Pasted image 20241112144929.png|300]]

### Reliability - Data Link vs TCP

- ![[Pasted image 20241112145400.png|300]]![[Pasted image 20241112145419.png|300]]
...
- 3-Way Handshake with nonce seq ![[Pasted image 20241112151824.png|300]]
...
- src dest identified by IP + PORT
  ![[Pasted image 20241112151844.png|300]]
...
4. Hence 3 phase disconnect handshake After sending disconnect and receiving disconnect ack, both sender and receiver set short timers.
   ![[Pasted image 20241112152608.png|300]]
...
- timer as backup, use 3 dup acks to identify ![[Pasted image 20241112153315.png|300]]

#### TCP SACK - Selective ACK

- ack with last received in-order packet, BUT also send **sack** with received out of order packets ![[Pasted image 20241112153634.png|300]]
...
![[Pasted image 20241112154047.png|300]]

## QUIC - Quick UDP Internet Connections

- developed by google to make initial handshake faster with TLS
- Runs on UDP ![[Pasted image 20241112154234.png|300]]
...
- FREEZE - receiver could also send back a FREEZE message (wich contains a timeout) that keeps the connection open but stops the sender fro sending until it receives another packet from the node that sent the freeze - needs seq numbers for freeze because delayed duplicates may restart freeze timeout
  ![[Pasted image 20241114145012.png|300]]

### Congestion Control

- different connection bandwidths leads to congestion on high output senders![[Pasted image 20241114145041.png|300]]
- queue builds if send rate > drain rate -> dropped packets
- "goodput" amount of packets that come "out" of the network ![[Pasted image 20241114145810.png|300]]
- Congestion causes both collapsed throughput ("goodput") and massive latency ![[Pasted image 20241114150031.png|300]]

#### Fair Bandwidth Allocation

- Can use **Ford-Fulkerson Maximum Flow Algo** ![[Pasted image 20241114145736.png|300]]

#### Mitigation

- ![[Pasted image 20241114152455.png|300]]
...
- Proactive Congestion Control - stay left of knee; Reactive - stay left of cliff ![[Pasted image 20241114151414.png|300]]
...
- Basic Algo ![[Pasted image 20241114151750.png|300]]
  - ssthresh cliff to mitigate exponential opening on slow start![[Pasted image 20241114151941.png|300]]
  - ![[Pasted image 20241114152053.png|300]]

#### Probing the Network

- ![[Pasted image 20241114151730.png|300]]
- ![[Pasted image 20241114151907.png|300]]
...
- ![[Pasted image 20241114151925.png|300]]
- ![[Pasted image 20241114151959.png|300]]
...
- e.g. ![[Pasted image 20241114152221.png|300]]
- all together ![[Pasted image 20241114152249.png|300]]
...
- router also need to schedule packets to support congestion control ![[Pasted image 20241114152608.png|300]]
- use fair queueing -> also allow TCP-UDP bandwidth share ![[Pasted image 20241114152750.png|300]]
- Round-Robin ![[Pasted image 20241114152803.png|300]]
- but we need to weight round robin due to differing packet sizes on top of queue frequent use

#### DRR - Deficit Round Robin

- use a deficit counter that starts with some quantum size, then decrease the deficit by the packet size sent ![[Pasted image 20241114152933.png|300]]
- after packet sent at robin pointer ![[Pasted image 20241114152942.png|300]]
- also enable **Random Early Detect** - randomly drop a packet early before congestion if ECN not set so that an ECN may be sent early ![[Pasted image 20241114153154.png|300]]

#### Novel Approaches

![[Pasted image 20241114153231.png|300]]
